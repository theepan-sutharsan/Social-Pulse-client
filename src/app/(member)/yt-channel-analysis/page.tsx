...
export default function YTChannelAnalysisPage() {
  ...
  const handleAnalyze = async (e: React.FormEvent) => {
    ...
    try {
      const res = await startChannelAnalysisApi(channelUrl.trim());
      clearTimeout(t1);
      clearTimeout(t2);
  ...
  const stepLabels: Record<typeof step, string> = {
    ...
    analyzing: 'Claude AI is analyzing patterns & generating ideas...',
  };
              ...
              {!currentRun && !loading && (
                <div className="text-center py-16 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm max-w-sm mx-auto">
                    ...
                    analyze transcripts, and use Claude AI to generate content ideas and a full script.
                  </p>
                </div>
              )}
